 ...
 */
     public static void checkAge(int yearOfBirth){
      ...
      int currentAge = (currentYear - yearOfBirth);
       if(currentAge > 100 || currentAge < 0){
        System.out.println("Age " + currentAge + " is not valid");
      }else if(currentAge < 16 ){
        System.out.println("Age" + currentAge + " is not allowed");
      }else
        System.out.println("The " + currentAge  + " is allowed");
    }
/*
 ...
 */
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Arrays.toString(HomeworkR4.no3or5(new int[]{3, 4, 5, 6})));
    System.out.println(Arrays.toString(HomeworkR4.noA(new String[]{"java", "appium", "ABC"})));
    System.out.println(HomeworkR4.averageOfEdges(-3, 15, -3));
  }
}
