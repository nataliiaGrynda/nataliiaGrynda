...
/*
  ...
  System.out.println("Age is = " + age);
   ...
   // System.out.println(names[5]);// ArrayoutOfBoundExeption
    ...
    //Alex age 20 and his fav char is A. His balance is 5.6 and he likes java is false
   // System.out.println(names[0] + "s age is " + ages[0] + " and hid fava char is " + favCharacters[0] + ".");
